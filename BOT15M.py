...
def get_price(pair):
    ...
    try:
        if response.status_code == 200:
            ...
            if  current_volume > previous_volume > 20000 and percentage_change_vol > 60 and abs(percentage_change) > 2:
            ...
            if close_price > max(close_price_break) and current_volume > previous_volume and previous_volume > 20000:
            ...
            elif close_price < min(close_price_break) and current_volume > previous_volume  and previous_volume > 20000:
